...
function checkEmail(str) {
  return (/^[a-zA-Z0-9]+\W?[a-zA-Z]+@[a-zA-Z\.]+\.[a-zA-Z]{2,4}$/).test(str);
}
...
function checkDomainUrl(str) {
  return (/^(http:|https:)\/\/([a-zA-Z0-9-_]+\.)*[a-zA-Z0-9][a-zA-Z0-9-_]+\.[a-zA-Z0-9]{2,5}?$/).test(str);
}

console.log(checkDomainUrl('http://external.asd1230-123.asd_internal.asd.gm-_ail.com'),'str'); // true
